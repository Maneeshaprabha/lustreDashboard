        ...
        <motion.div variants={itemVariants} className="xl:col-span-2 bg-white p-7 rounded-[2rem] shadow-sm border border-[#C4BEB6]/20 flex flex-col min-h-[400px]">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-[#1A1A1A]/50 font-medium mt-1">Daily revenue over the last 14 days</p>
            </div>
          ...
          <div className="flex-1 bg-[#E9E3DB]/30 rounded-2xl border-2 border-dashed border-[#C4BEB6]/40 flex items-center justify-center relative overflow-hidden">
            <div className="text-center z-10 relative">
              <CreditCard className="mx-auto text-[#1A1A1A]/20 mb-3" size={48} />
              <p className="text-[#1A1A1A]/40 font-bold text-sm">Line Chart Visualization Area</p>
            </div>
            ...
            <svg className="absolute inset-0 w-full h-full opacity-20 pointer-events-none" preserveAspectRatio="none" viewBox="0 0 100 100">
              <path d="M0,80 Q10,70 20,85 T40,60 T60,75 T80,40 T100,20 L100,100 L0,100 Z" fill="#1A1A1A" opacity="0.1" />
              <path d="M0,80 Q10,70 20,85 T40,60 T60,75 T80,40 T100,20" fill="none" stroke="#1A1A1A" strokeWidth="2" />
            </svg>
          </div>
        </motion.div>
