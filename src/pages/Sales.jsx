      ...
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="p-4 sm:p-6 md:p-10 max-w-[1400px] w-full mx-auto space-y-6 sm:space-y-8">
                ...
                <div className="absolute inset-0 flex flex-col justify-between pt-2 pb-8 px-2">
                  {['15k', '10k', '5k', '0'].map((val, i) => (
                    <div key={i} className="flex items-center gap-4 w-full">
                      <span className="text-[10px] sm:text-xs font-bold text-[#0F0E0D]/30 dark:text-white/30 w-8 text-right transition-colors">{val}</span>
          ...
          <motion.div variants={itemVariants} className="bg-white dark:bg-[#111111] p-6 sm:p-8 md:p-10 rounded-[2.5rem] shadow-sm border border-[#EBE6E0] dark:border-white/10 flex flex-col justify-between transition-colors">
            <div>
              ...
              <div className="bg-[#0F0E0D] dark:bg-[#1A1A1A] border dark:border-white/10 rounded-2xl p-6 sm:p-8 text-[#E9E3DB] relative overflow-hidden shadow-lg mb-6 sm:mb-8 transition-colors">
                ...
                <p className="text-3xl sm:text-4xl font-bold tracking-tight mb-6 sm:mb-8 text-white">$42,850.00</p>
                
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-[10px] sm:text-xs text-[#E9E3DB]/50 dark:text-white/50 mb-1 transition-colors">Next Payout</p>
                    <p className="font-bold text-xs sm:text-sm text-white">Aug 10, 2026</p>
                  </div>
        ...
        <motion.div variants={itemVariants} className="bg-white dark:bg-[#111111] p-6 sm:p-8 md:p-10 rounded-[2.5rem] shadow-sm border border-[#EBE6E0] dark:border-white/10 overflow-hidden transition-colors">
          <div className="flex justify-between items-center mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl font-bold text-[#0F0E0D] dark:text-white transition-colors">Recent Transactions</h2>
            <button className="text-xs sm:text-sm font-bold text-[#0F0E0D]/60 dark:text-white/60 hover:text-[#0F0E0D] dark:hover:text-white transition-colors">View All</button>
          </div>
                ...
                {salesData.map((trx, index) => {
                  ...
                  return (
                    <tr key={index} className="border-b border-[#EBE6E0] dark:border-white/10 hover:bg-[#EBE6E0]/30 dark:hover:bg-white/5 transition-colors group">
                      <td className="px-4 sm:px-6 py-4 sm:py-5 font-bold text-[#0F0E0D]/80 dark:text-white/80 transition-colors">{trx.id}</td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 font-bold text-[#0F0E0D] dark:text-white transition-colors">{trx.customer}</td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 font-medium text-[#0F0E0D]/60 dark:text-white/60 transition-colors">{trx.items} item(s)</td>
                      <td className="px-4 sm:px-6 py-4 sm:py-5 font-medium text-[#0F0E0D]/60 dark:text-white/60 transition-colors">{trx.date}</td>
                      ...
                      <td className="px-4 sm:px-6 py-4 sm:py-5 font-bold text-[#0F0E0D] dark:text-white text-right transition-colors">{trx.amount}</td>
